            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" 
                        ...
                        <div class="mb-3">
                            <label for="periodo" class="form-label">Nombre Periodo</label>
                            <input type="text" name="periodo" class="form-control" id="periodo"
                                   value="{{ old('periodo', $periodo->periodo ?? '') }}" {{$desabilitado}}>
                            @error('periodo')
                                <ul class="list-unstyled text-danger">
                                    <p>Error en el nombre del periodo: {{ $message }}</p>
                                </ul>
                            @enderror
                            <div class="form-text">Escribe el nombre del periodo</div>
                        </div>
